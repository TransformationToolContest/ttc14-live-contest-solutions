...
{ for (int i = 0; i < players.size(); i++)
  ...
  { ShootBall a = new ShootBall();
    ...
    public void cmaction(Update u)
  {   if (this.getball().size() > 0 && this.getfield().getxPos() < 42) 
...
public void setyDist(Action actionx, int yDist_x) 
  ...
  public void cmaction(Player playerx,Update u)
  {   playerx.cmaction(u);
   }

  public  List AllPlayercmaction(List playerxs,Update u)
  { 
    List result = new Vector();
    for (int i = 0; i < playerxs.size(); i++)
    { Player playerx = (Player) playerxs.get(i);
  ...
  { 
    ...
    Controller.inst().cmaction(player5,u);
